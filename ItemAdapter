package com.elenakozachenko.githubtest;
...
import com.elenakozachenko.githubtest.controller.DetailActivity;
         ...
         itemView.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 ...
                 if (pos != RecyclerView.NO_POSITION) {
                     ...
                     Toast.makeText(v.getContext(), "You clicked" + clickedDataItem.getLogin()
